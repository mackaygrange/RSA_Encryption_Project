...
unsigned long long int RSA_Encryption(int p, int q, int e, int m)
{
    int n = p * q;
...
unsigned long long int RSA_Decryption(int c, int d, int n)
{
...
int main()
{
    ...
    std::cout << "Public Key Pair: {" << n << ", " << e << "}" << std::endl;
    std::cout << "Private Key Pair: {" << n << ", " << d << "}" << std::endl;
    std::cout << std::endl;
